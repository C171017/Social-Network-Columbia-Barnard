  ...
  return (
    <div className="instr-overlay">
      <div className="instr-box">
        ...
        <p>Here is how to navigate the graph:</p>
        <ul>
          <li>Press and hold a node to unfold its entire group.</li>
          <li>Click any node to toggle focus on that group.</li>
          <li>Use the control panel at the bottom-right to change the viewing property.</li>
        </ul>
        ...
        <p style={{ fontSize: '0.85em' }}>
          GitHub:{' '}
          <a
            href="https://github.com/C171017/Social-Network-Columbia-Barnard"
            target="_blank"
        ...
        <button className="instr-close" onClick={onClose}>
          Got it!
        </button>
      </div>
    </div>
